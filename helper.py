...
def most_successful(df, sport):
    ...
    x['Medals'] = x['Medals'].astype(str)

    merged_df = x.merge(df, left_on='Name', right_on='Name', how='left').drop_duplicates(subset='Name')
...
def most_successful_countrywise(df, country):
    ...
    x = temp_df['Name'].value_counts().reset_index(name='count').head(10)
    x.columns = ['Name', 'Medals']
    x['Medals'] = x['Medals'].astype(str)
